...
namespace Player.Vm.Api.Data.Migrations.Postgres
{
    ...
    [Migration("20260504183045_AddXApiQueue")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Player.Vm.Api.Domain.Models.XApiQueuedStatementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Player.Vm.Api.Domain.Models.VmUser", b =>
                {
                    b.HasOne("Player.Vm.Api.Domain.Models.Vm", "LastVm")
                        .WithMany()
                        .HasForeignKey("LastVmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
