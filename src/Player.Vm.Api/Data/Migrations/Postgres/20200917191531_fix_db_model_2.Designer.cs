...
namespace Player.Vm.Api.Data.Migrations.Postgres
{
    ...
    [Migration("20200917191531_fix_db_model_2")]
    partial class fix_db_model_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Player.Vm.Api.Domain.Models.MapCoordinate", b =>
                {
            ...
            modelBuilder.Entity("Player.Vm.Api.Domain.Models.MapCoordinate", b =>
                {
                    b.HasOne("Player.Vm.Api.Domain.Models.Coordinate", "coordinate")
                        .WithMany("MapCoordinates")
                        .HasForeignKey("CoordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Player.Vm.Api.Domain.Models.VmMap", "vmMap")
                        .WithMany("MapCoordinates")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
