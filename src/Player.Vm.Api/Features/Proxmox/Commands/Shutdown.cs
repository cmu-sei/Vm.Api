    ...
    public class Shutdown
    {
        ...
        public class Handler : BaseHandler, IRequestHandler<Command, string>
        {
            ...
            public async Task<string> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var result = await _proxmoxService.ShutdownVm(vm.ProxmoxVmInfo);
                await _xApiService.TrackPowerOperationAsync(vm.Id, PowerOperation.Shutdown, cancellationToken);
                return result;
            }
        }
    }
